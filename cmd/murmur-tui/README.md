...
- Pulse Map effects: terminal glow/ripple/particle/background frames; `v` toggles contrast mode substitute
...
- Anonymous extras: `7` Sparks panel, `8` Pulse Beats ticker
...
- Settings: `Ctrl+,` toggle settings modal; numeric controls for mode/blend/overlays; `r/o/i/h` config toggles; `t` theme cycle; `w` wordlist sample regenerate
