...
func TestManager_SetAndGetTier(t *testing.T) {
	pp := NewManager(nil)
...
func TestManager_PromoteToSocial(t *testing.T) {
	pp := NewManager(nil)
...
func TestManager_PromoteToMesh_NoSocialDemotion(t *testing.T) {
	pp := NewManager(nil)
...
func TestManager_PromoteToMesh_FromDHT(t *testing.T) {
	pp := NewManager(nil)
...
func TestManager_PromoteToDHT_NoHigherTierDemotion(t *testing.T) {
	pp := NewManager(nil)
...
func TestManager_DemoteToOpportunistic(t *testing.T) {
	pp := NewManager(nil)
...
func TestManager_PeersInTier(t *testing.T) {
	pp := NewManager(nil)
...
func TestManager_TierCounts(t *testing.T) {
	pp := NewManager(nil)
...
func TestManager_WithConnManager(t *testing.T) {
